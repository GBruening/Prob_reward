...
Prob_plotting <- function(data,
  ...
  if (plot_type == 'RPE'){
    ...
    plot_var = paste('DiffPrior_',plot_var,sep='')
    
    plotting_data = data[,c('Subject','Trial','Trial_in_Block','Target','Target_num','Block','RWD','Prior_RWD','NRWD_Run','Probability','DiffCur_Prob',plot_var)]
    colnames(plotting_data) = c('Subject','Trial','Trial_in_Block','Target','Target_num','Block','RWD','Prior_RWD','NRWD_Run','Probability','DiffCur_Prob', 'plot_var')
