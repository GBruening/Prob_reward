---
title: "Prob_RWD_Rand_block"
author: "Garrick Bruening"
output:
  bookdown::html_document2:
    toc: true
  bookdown::pdf_document2: default
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), 'Prob_RWD_Rand_block.html')) })
---
...
# main_folder = 'd:/Users/Gary/Google Drive/Yan Experiment/code'
setwd(main_folder)

exp_name = '4t_180trial_4block'
exp_name = 'Rand_block'
# setwd(paste(main_folder[1:length(main_folder)-5],'/',exp_name,sep=''))
...
raw_data[raw_data$RPE > 0.01,'RPE'] = raw_data[raw_data$RPE > 0.01,'RPE'] - 0.01
...
non_famil_data$probs = non_famil_data$r_prob
...
non_famil_data[non_famil_data$DiffPrior_Prob == 0.67, 'DiffPrior_Probability'] = non_famil_data[non_famil_data$DiffPrior_Prob == 0.67, 'DiffPrior_Probability']-0.01
non_famil_data[non_famil_data$DiffPrior_Prob == 0.34, 'DiffPrior_Probability'] = non_famil_data[non_famil_data$DiffPrior_Prob == 0.34, 'DiffPrior_Probability']-0.01
non_famil_data$Diff_prob = non_famil_data$DiffPrior_Probability
...
Prob_plotting <- function(data,
  ...
  if (prob_method == 'prior_RPE' || prob_method == 'RPE'){
    ...
    lme_test_Prior0 <- cftest(lmer(plot_var ~ probability_metric + (1|Subject), 
      ...
      if ( 0 %in% unique(plotting_data$probability_metric)){
  ...
  if (Prior_RWD == 'Prior_RWD'){
    ...
    if (plot_type == 'bar'){
      ...
      g<-ggplot(data = c,
        ...
        labs(x = 'Probability of Reward',
             ...
             color = 'Prior\nReward')
      if (titles == 'TRUE'){
        g <-  g+labs(title = paste('LMER P-Values.\nProb Metric: ',
                           formatC(lme_test$test$pvalues[2],format="e",digits = 3),
                           ',\nPrior Rwd: ',
    ...
    } else if (plot_type == 'nv' & subj_split == 'Null') {
    ...
    } else if (plot_type == 'nv' & subj_split == 'subj') {
...
for (k in 1:length(testable_vars)){
  ...
  plots[[testable_vars[k]]][['Delta']] <- Prob_plotting(data= filt_data,
                                                 prob_method = 'Probability',
                                                 plot_var = paste('Delta',testable_vars[k],sep=''),
                                                 var_lab = paste(testable_vars_labels[k],' DELTA (m/s)',sep=''),
                                                 plot_type = 'nv',
                                                 title_lab = 'DELTA',
                                                 Prior_RWD = '0')
  
  plots[[testable_vars[k]]][['Delta_subj']] <- Prob_plotting(data= filt_data,
                                                 prob_method = 'Probability',
                                                 plot_var = paste('Delta',testable_vars[k],sep=''),
                                                 var_lab = paste(testable_vars_labels[k],' DELTA (m/s)',sep=''),
                                                 plot_type = 'nv',
  ...
  plots[[paste('Delta',testable_vars[k],sep='')]][['Prior_RWD']] <- Prob_plotting(data= filt_data,
                                                   prob_method = 'Probability',
                                                   plot_var = paste('Delta',testable_vars[k],sep=''),
                                                   var_lab = paste('Delta ',testable_vars_labels[k],' (m/s)',sep=''),
                                                   plot_type = 'nv',
                                                   title_lab = 'ABS',
                                                   Prior_RWD = 'Prior_RWD')
  ...
  plots[[testable_vars[k]]][['RPE_split_prob']][['plot']] <- plots[[testable_vars[k]]][['RPE_split_prob']][['plot']]+
    labs(x = 'Reward Prediction Error on previous trial (RPE)')
  plots[[testable_vars[k]]][['RPE_split_prior']][['plot']] <- plots[[testable_vars[k]]][['RPE_split_prior']][['plot']]+
    labs(x = 'Reward Prediction Error on previous trial (RPE)')
  plots[[testable_vars[k]]][['RPE_no_split']][['plot']] <- plots[[testable_vars[k]]][['RPE_no_split']][['plot']]+
    labs(x = 'Reward Prediction Error on previous trial (RPE)')
}
```
...
p_vals_int   = c()
for (item in testable_vars){
  p_vals_prob  = c(p_vals_prob, plots[[item]][['RPE_no_split']]$lm$test$pvalues[2])
  p_vals_prior = c(p_vals_prior,plots[[item]][['RPE_no_split']]$lm$test$pvalues[3])
  p_vals_int   = c(p_vals_int,  plots[[item]][['RPE_no_split']]$lm$test$pvalues[4])
}
...
p_vals_prior0 = c()
for (item in testable_vars){
  p_vals_prior1  = c(p_vals_prior1, plots[[item]][['RPE_no_split']]$lme_test_Prior1$test$pvalues[2])
  p_vals_prior0  = c(p_vals_prior0, plots[[item]][['RPE_no_split']]$lme_test_Prior1$test$pvalues[2])
}
...
plot_grid(plots[[chunk_var]][['RPE_split_prob']][['plot']],
...
plots[[chunk_var]][['RPE_split_prob']] <- Prob_plotting(filt_data,
                                         prob_method = 'RPE',
...
plots[[chunk_var]][['RPE_split_prior']] <- Prob_plotting(filt_data,
                                         prob_method = 'RPE',
                                         plot_var = paste(chunk_var,sep=''),
                                         var_lab = paste(chunk_var_lab, sep = ''),
                                         plot_type = 'NULL',
...
plots[[chunk_var]][['RPE_no_split']] <- Prob_plotting(filt_data,
                                         prob_method = 'RPE',
                                         plot_var = paste(chunk_var,sep=''),
                                         var_lab = paste(chunk_var_lab, sep = ''),
                                         plot_type = 'NULL',
...
plots[[chunk_var]][['RPE_split_prob']][['plot']] <- plots[[chunk_var]][['RPE_split_prob']][['plot']]+
  labs(x = 'Reward Prediction Error on CURRENT trial (RPE)')
plots[[chunk_var]][['RPE_split_prior']][['plot']] <- plots[[chunk_var]][['RPE_split_prior']][['plot']]+
  labs(x = 'Reward Prediction Error on CURRENT trial (RPE)')
plots[[chunk_var]][['RPE_no_split']][['plot']] <- plots[[chunk_var]][['RPE_no_split']][['plot']]+
  labs(x = 'Reward Prediction Error on CURRENT trial (RPE)')
