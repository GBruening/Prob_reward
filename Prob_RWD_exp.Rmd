...
kable(pvalue_table_func(filt_data,
                        plot_var = paste('Norm',var_test,sep=''), 
                        prob_metric = 'Probability', 
                        Prior_RWD = 'no'), 
      caption = 'Peak Velocity Norm P-Values for effect of Probability')
kable(pvalue_table_func(filt_data,
                        plot_var = 'DeltaPeakV', 
                        prob_metric = 'Probability', 
                        Prior_RWD = 'no'), 
      caption = 'Peak Velocity Delta P-Values for effect of Probability')
```
...
kable(pvalue_table_func(filt_data,
                        plot_var = 'DiffPrior_PeakV',
                        prob_metric = 'Probability', 
                        Prior_RWD = 'no'),
      caption = 'Peak Velocity Difference from previous Trial P-Values for effect of Probability')
kable(pvalue_table_func(filt_data,
                        plot_var = 'DiffPrior_NormPeakV', 
                        prob_metric = 'Probability', 
                        Prior_RWD = 'no'), 
      caption = 'Peak Velocity Norm Difference from previous Trial -Values for effect of Probability')
kable(pvalue_table_func(filt_data,
                        plot_var = 'DiffPrior_DeltaPeakV', 
                        prob_metric = 'Probability', 
                        Prior_RWD = 'no'), 
      caption = 'Peak Velocity Delta Difference from previous Trial P-Values for effect of Probability')
```
...
kable(pvalue_table_func(filt_data,
                        ...
                        prob_metric = 'Probability', 
                        Prior_RWD = 'Prior_RWD'), 
      caption = 'Peak Velocity Norm, diff from perv trial, P-Values for effect of Probability')
kable(pvalue_table_func(filt_data,
                        plot_var = 'DiffPrior_DeltaPeakV', 
                        prob_metric = 'Probability', 
                        Prior_RWD = 'Prior_RWD'), 
      caption = 'Peak Velocity Delta, diff from perv trial, P-Values for effect of Probability')
```
