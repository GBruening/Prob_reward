...
testable_vars = c('PeakV','RT','Max_Ex','Duration','TotalDur','Vigor')

# Make a summary Bar chart for just effect of Probability
plots[['PeakV']][['abs']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'PeakV',
...
plots[['RT']][['abs']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'RT',
                                             var_lab = 'Reaction Time (s)',
                                             plot_type = 'nv',
                                             title_lab = 'ABS',
                                             Prior_RWD = '0')

plots[['Max_Ex']][['abs']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'Max_Ex',
                                             var_lab = 'Maximum Excursion (m)',
                                             plot_type = 'nv',
                                             title_lab = 'ABS',
                                             Prior_RWD = '0')

plots[['Duration']][['abs']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'Duration',
                                             var_lab = 'Movement Duration (s)',
                                             plot_type = 'nv',
                                             title_lab = 'ABS',
                                             Prior_RWD = '0')

plots[['TotalDur']][['abs']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'TotalDur',
                                             var_lab = 'Total Duration (s)',
                                             plot_type = 'nv',
                                             title_lab = 'ABS',
                                             Prior_RWD = '0')


plots[['Vigor']][['abs']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'Vigor',
                                             var_lab = 'Vigor',
                                             plot_type = 'nv',
...
plots[['PeakV']][['Prior_RWD']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'PeakV',
                                             var_lab = 'Peak Velocity (m/s)',
                                             plot_type = 'nv',
...
plots[['RT']][['Prior_RWD']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'RT',
                                             var_lab = 'Reaction Time (s)',
                                             plot_type = 'nv',
...
plots[['Max_Ex']][['Prior_RWD']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'Max_Ex',
                                             var_lab = 'Maximum Excursion (m)',
                                             plot_type = 'nv',
...
plots[['Duration']][['Prior_RWD']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'Duration',
                                             var_lab = 'Movement Duration (s)',
                                             plot_type = 'nv',
...
plots[['TotalDur']][['Prior_RWD']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'TotalDur',
                                             var_lab = 'Total Duration (s)',
                                             plot_type = 'nv',
...
plots[['Vigor']][['Prior_RWD']] <- Prob_plotting(data= filt_data,
                                             prob_method = 'Probability',
                                             plot_var = 'Vigor',
                                             var_lab = 'Vigor',
                                             plot_type = 'nv',
...
pval_plot_prior_split <- ggplot()+
  ...
  labs(x = 'Tested Variable',
       y = 'LMER P-Value',
       fill = 'Was Previous Trial\nRewarded')+
  theme(axis.text.x = element_text(angle = 30, hjust = 1))+
  scale_y_continuous(expand = c(0,0))+
  geom_hline(yintercept =  0.05,
             color = 'black',
             size = 2)+
  scale_fill_discrete(labels = c('Prior RWD','No Prior RWD'))
...
```{r, echo = FALSE, warning = FALSE, fig.height = 9, fig.width = 12}
...
We also compute an TukeyHSD post hoc to determine if there are differences between individual conditions. The table below shows the results of the Tukey test (table \@ref(tab:peakvtukeytable)).

```{r peakvtukeytable, echo = FALSE, warning = FALSE, message = FALSE}

kable(tukey_test_table(cur_plot$tukey_test),caption = paste('Tukey HSD test for ',chunk_var_lab,sep=''))
...
We also compute an TukeyHSD post hoc to determine if there are differences between individual conditions. The table below shows the results of the Tukey test (table \@ref(tab:rttukeytable)).

```{r rttukeytable, echo = FALSE, warning = FALSE, message = FALSE}
...
We also compute an TukeyHSD post hoc to determine if there are differences between individual conditions. The table below shows the results of the Tukey test (table \@ref(tab:maxextukeytable)).

```{r maxextukeytable, echo = FALSE, warning = FALSE, message = FALSE}
...
We also compute an TukeyHSD post hoc to determine if there are differences between individual conditions. The table below shows the results of the Tukey test (table \@ref(tab:durationtukeytable)).

```{r durationtukeytable, echo = FALSE, warning = FALSE, message = FALSE}
...
We also compute an TukeyHSD post hoc to determine if there are differences between individual conditions. The table below shows the results of the Tukey test (table \@ref(tab:totdurationtukeytable)).

```{r totdurationtukeytable, echo = FALSE, warning = FALSE, message = FALSE}
...
We also compute an TukeyHSD post hoc to determine if there are differences between individual conditions. The table below shows the results of the Tukey test (table \@ref(tab:vigortukeytable)).

```{r vigortukeytable, echo = FALSE, warning = FALSE, message = FALSE}
