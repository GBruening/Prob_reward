...
p_vals = c(plots[['PeakV']][['abs']]$lm$test$pvalues[2],
           plots[['RT']][['abs']]$lm$test$pvalues[2],
           plots[['Max_Ex']][['abs']]$lm$test$pvalues[2],
           plots[['Duration']][['abs']]$lm$test$pvalues[2],
           plots[['TotalDur']][['abs']]$lm$test$pvalues[2],
           plots[['Vigor']][['abs']]$lm$test$pvalues[2])
...
pval_plot <- ggplot()+
  geom_bar(data=p_val_df,
           aes(x=factor(var_num),
               y=p_val),
           stat = 'identity')+
  scale_x_discrete(limits = c(1:6), labels = p_val_df$variable)+
